...
public class BoardDateItemViewHolder extends AbstractViewHolder {
    ...
    public void setItemModel(BoardDateItemModel itemModel, String columnTitle) {
        tvContent.setText(itemModel.getContent());
        itemView.setOnClickListener((view) -> handlers.OnDateItemClick(itemModel, columnTitle));
    }
